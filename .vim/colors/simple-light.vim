...
if !(&t_Co == 256 || has('gui_running'))
  ...
  if exists("syntax_on")
	...
	let colors_name="simple-light"
	set background=dark

	" General Colors
	hi Normal       guifg=#d7d7d7   guibg=#262626   ctermfg=235	   ctermbg=256       gui=none      cterm=none
	hi Comment      guifg=#8a8a8a   guibg=NONE      ctermfg=245    ctermbg=NONE      gui=none      cterm=none
	hi Constant     guifg=#d7d7af   guibg=NONE      ctermfg=204    ctermbg=NONE      gui=none      cterm=none
	hi Identifier   guifg=#afd7d7   guibg=NONE      ctermfg=75     ctermbg=NONE      gui=none      cterm=none
	hi Statement    guifg=#87afd7   guibg=NONE      ctermfg=103    ctermbg=NONE      gui=none      cterm=none
	hi PreProc      guifg=#87afd7   guibg=NONE      ctermfg=103    ctermbg=NONE      gui=none      cterm=none
	...
	hi StatusLine   guifg=#121212   guibg=#b2b2b2   ctermfg=242    ctermbg=255       gui=none      cterm=none
